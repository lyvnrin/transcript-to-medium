...
3. KEY TAKEAWAYS — an h2 reading exactly 'Key Takeaways', then an unordered list where each item is the topic name bolded, followed by a one-sentence takeaway. This doubles as a table of contents. After the list, an hr tag on its own line to mark the break before the first section.
